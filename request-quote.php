<?php
$page_title = 'Request A Quote | Zoren Trading';
$page_desc = 'Request a customized quote for bulk industrial supplies.';
include 'header.php';
?>
    ...
    <div class="page-banner" style="background-image: url('assets/images/about.png');">
        ...
        <div class="container text-center">
            <h1 class="display-4 font-heading fw-bold text-white mb-3">Request A Quote</h1>
            <p class="lead text-light mx-auto" style="max-width: 700px;">Request a customized quote for bulk industrial supplies.</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h3 class="mb-4">Content for Request A Quote</h3>
